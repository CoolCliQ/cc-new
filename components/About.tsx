        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-black tracking-tight mb-6 leading-tight">
              ...
              <br />
              It’s a{' '}
              <span className="text-brand-yellow bg-black px-2 transform -skew-x-3 inline-block">
                strategy.
              </span>
            </h2>
            <p className="text-lg text-zinc-600 mb-6 leading-relaxed">
              We make brands unstoppable. Because growth is a journey — and you shouldn’t walk
              alone.
            </p>
            <p className="text-lg text-zinc-600 mb-8 leading-relaxed">
              We’re a full-scale digital partner built on the pillars of Strategy, Creativity &
              Performance. From branding and campaigns to websites and SEO, we turn great ideas into
              measurable results.
            </p>
              ...
              {[
                {
                  icon: BrainCircuit,
                  title: 'Clarity',
                  desc: 'A plan that knows where it’s going.',
                },
                {
                  icon: PenTool,
                  title: 'Creativity',
                  desc: 'Ideas that get noticed & remembered.',
                },
                { icon: TrendingUp, title: 'Performance', desc: 'Marketing that pays for itself.' },
              ].map((item, idx) => (
                <div
                  key={idx}
                  className="flex items-start gap-4 p-4 rounded-2xl hover:bg-zinc-50 transition-colors border border-transparent hover:border-zinc-100"
                >
