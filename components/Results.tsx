        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            <div>
                ...
                <p className="text-xl text-zinc-400 mb-8">
                    Performance isn’t a promise — it’s proof. Every number here is a story of strategy well executed.
                </p>
                <div className="flex gap-4">
                    <div className="flex -space-x-4">
                        {[1, 2, 3, 4].map((i) => (
                            <img key={i} className="w-12 h-12 rounded-full border-4 border-brand-black" src={`https://picsum.photos/50/50?random=${i+10}`} alt="Client" />
                        ))}
                    </div>
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-zinc-900/50 border border-zinc-800 p-6 rounded-3xl backdrop-blur-sm hover:bg-zinc-800/50 transition-colors">
                     <div className="flex justify-between items-start mb-4">
                        ...
                        <span className="text-xs font-bold text-zinc-500 uppercase tracking-wider">Leads</span>
                    </div>
                 ...
                 <div className="col-span-2 bg-zinc-900/50 border border-zinc-800 p-6 rounded-3xl backdrop-blur-sm hover:bg-zinc-800/50 transition-colors flex items-center justify-between">
                     ...
                     <div className="w-24 h-24 relative flex items-center justify-center">
                        <svg className="w-full h-full transform -rotate-90">
                            ...
                            <circle cx="48" cy="48" r="40" stroke="currentColor" strokeWidth="8" fill="transparent" strokeDasharray="251.2" strokeDashoffset="25" className="text-brand-yellow" />
                        </svg>
        ...
        <div className="rounded-[2rem] bg-zinc-900 border border-zinc-800 overflow-hidden relative">
            ...
            <div className="p-8 md:p-12 text-center relative z-20">
                 ...
                 <div className="grid md:grid-cols-3 gap-6">
                    {[1, 2, 3].map((item) => (
                        <div key={item} className="aspect-[9/16] bg-zinc-800 rounded-2xl relative group cursor-pointer overflow-hidden border border-white/5">
                            <img src={`https://picsum.photos/400/700?random=${item+20}`} alt="Testimonial thumbnail" className="w-full h-full object-cover opacity-60 group-hover:opacity-100 transition-opacity duration-500" />
