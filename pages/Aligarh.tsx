...
const testimonials = [
    ...
    {
        type: 'video',
        videoUrl: "https://images.unsplash.com/photo-1557804506-669a67965ba0?q=80&w=1974&auto=format&fit=crop",
        name: "Priya Sharma",
    ...
    {
        type: 'video',
        videoUrl: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=1976&auto=format&fit=crop",
        name: "Fatima Khan",
        role: "Boutique Owner",
     ...
     {
        type: 'video',
        videoUrl: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=2070&auto=format&fit=crop",
        name: "Amit Varshney",
    ...
    {
        type: 'video',
        videoUrl: "https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=1974&auto=format&fit=crop",
        name: "Vikram Singh",
      ...
      <section className="relative min-h-screen flex items-center pt-24 md:pt-36 pb-20 overflow-hidden bg-brand-black">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-8 hover:bg-white/10 transition-colors">
            ...
            <span className="text-sm font-medium text-zinc-300">Aligarh’s Trusted Digital Growth Partner</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-zinc-300 max-w-3xl mx-auto mb-10 leading-relaxed font-medium drop-shadow-md">
            Aligarh’s businesses deserve more than ordinary marketing. They deserve Strategy that thinks, Creativity that attracts, and Performance that sells.
          </p>
          ...
          <div className="relative w-full max-w-4xl mx-auto perspective-1000 group">
             ...
             <div className="relative rounded-2xl bg-zinc-900 border border-white/10 shadow-2xl overflow-hidden aspect-video transform-gpu z-10">
                 ...
                 <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black via-black/50 to-transparent text-left">
                    <p className="text-zinc-400 text-sm font-bold uppercase tracking-wider mb-1">Welcome to CoolCliQ</p>
      ...
      <section id="about" className="py-24 bg-white text-brand-black relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-5 gap-12 items-center">
            ...
            <div className="lg:col-span-2 relative z-10">
                <div className="inline-block bg-brand-yellow px-3 py-1 text-xs font-bold uppercase tracking-widest mb-4">Our Mission</div>
                ...
                <p className="text-lg text-zinc-600 mb-8 font-medium leading-relaxed">
                   We’re here to turn that ambition into measurable success. CoolCliQ is the bridge between local potential and global-standard growth.
                </p>
            ...
            <div className="lg:col-span-3 relative h-[500px] w-full hidden md:block">
                 ...
                 <div className="absolute top-10 right-0 w-[80%] h-[80%] rounded-[2.5rem] overflow-hidden shadow-2xl z-0 transform rotate-2 hover:rotate-0 transition-transform duration-500">
                    <img src="https://images.unsplash.com/photo-1531482615713-2afd69097998?q=80&w=2070&auto=format&fit=crop" className="w-full h-full object-cover" alt="Creative Strategy" />
                    <div className="absolute inset-0 bg-black/20"></div>
                 </div>

                 {/* Floating Card 1: Strategy */}
                 <div className="absolute top-0 left-10 bg-white p-5 rounded-2xl shadow-xl z-10 animate-bounce" style={{ animationDuration: '3s' }}>
                    <div className="flex items-center gap-3">
                        <div className="bg-purple-100 p-2 rounded-lg text-purple-600"><Building2 className="w-5 h-5" /></div>
                        <div>
                 ...
                 <div className="absolute bottom-20 right-10 bg-brand-yellow p-5 rounded-2xl shadow-xl z-20 transform rotate-3">
                    <div className="flex items-center gap-3">
                        <div className="bg-black/10 p-2 rounded-lg text-black"><TrendingUp className="w-5 h-5" /></div>
                        <div>
                 ...
                 <div className="absolute bottom-0 left-20 bg-black text-white p-5 rounded-2xl shadow-xl z-20 -rotate-2">
                    <div className="flex items-center gap-3">
                        <div className="bg-white/20 p-2 rounded-lg"><Palette className="w-5 h-5" /></div>
                        <div>
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {[
                    ...
                    <div key={i} className="bg-white p-6 rounded-2xl flex flex-col items-center justify-center gap-4 hover:shadow-lg hover:-translate-y-1 transition-all duration-200 aspect-square text-center">
             ...
             <div className="mt-12">
                <a href="#results" className="inline-flex items-center gap-2 font-bold bg-black text-white px-6 py-3 rounded-full hover:scale-105 transition-transform">
      ...
      <section className="py-24 bg-zinc-50">
        <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-12">
                <h3 className="text-2xl font-bold text-zinc-400 uppercase tracking-widest">Trusted By 30+ Aligarh Brands</h3>
            </div>
                ...
                {testimonials.map((item, i) => (
                    <div key={i} className="break-inside-avoid">
                        {item.type === 'video' ? (
                            ...
                            <div className={`relative group rounded-3xl overflow-hidden cursor-pointer shadow-lg hover:shadow-2xl transition-all duration-300 transform-gpu backface-hidden hover:-translate-y-1 ${item.aspect || 'aspect-[9/16]'}`}>
                                <img src={item.videoUrl} alt={item.name} className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                            ...
                            <div className="bg-white p-6 rounded-3xl border border-zinc-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                                 <div className="flex items-start justify-between mb-4">
                                    <div className="flex items-center gap-3">
                                        <img 
                                            src={item.avatar || `https://ui-avatars.com/api/?name=${item.name}&background=f0f0f0&color=000`} 
                                            alt={item.name} 
      ...
      <section id="contact" className="py-24 bg-brand-black text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-xl text-zinc-400 mb-10 max-w-2xl mx-auto">
                Strategy unlocks growth. Creativity sparks attention. Performance drives revenue. If your brand deserves to win, we’re ready to lead.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="#contact" className="px-8 py-4 bg-brand-yellow text-black rounded-full font-bold text-lg hover:scale-105 transition-transform w-full sm:w-auto shadow-lg shadow-brand-yellow/20">
                    Start Now 🚀
                </a>
                <a href="https://wa.me/918126962266" className="px-8 py-4 bg-zinc-800 text-white border border-white/10 rounded-full font-bold text-lg hover:bg-zinc-700 transition-transform w-full sm:w-auto">
