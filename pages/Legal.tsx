    ...
    <div className="bg-white text-zinc-900 min-h-screen pt-24 pb-20">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-12">
          <a
            href="/"
            className="inline-flex items-center gap-2 text-sm font-bold text-zinc-500 hover:text-brand-yellow transition-colors mb-6"
          >
        ...
        <div className="grid gap-16">
          ...
          <section>
            ...
            <div className="prose prose-lg text-zinc-600 max-w-none">
              <p>
                At CoolCliQ ("we", "us", or "our"), we respect your privacy and are committed to
          ...
          <section>
            ...
            <div className="prose prose-lg text-zinc-600 max-w-none">
              <p>
                ...
                continue to use CoolCliQ if you do not agree to take all of the terms and conditions
                stated on this page.
              </p>

              <h3 className="text-black font-bold mt-8 mb-4 text-xl">1. Services</h3>
              <p>
                CoolCliQ provides digital marketing, branding, and development services. The
                specific deliverables and timelines for any project will be outlined in a separate
                Statement of Work (SOW) or contract agreed upon by both parties.
              </p>

              <h3 className="text-black font-bold mt-8 mb-4 text-xl">2. Intellectual Property</h3>
              <p>
                Unless otherwise stated, CoolCliQ and/or its licensors own the intellectual property
                rights for all material on CoolCliQ. All intellectual property rights are reserved.
                You may access this from CoolCliQ for your own personal use subjected to
                restrictions set in these terms and conditions.
              </p>

              <h3 className="text-black font-bold mt-8 mb-4 text-xl">3. Payment Terms</h3>
              <p>
                Payment schedules will be defined in individual client contracts. Generally, a
                deposit is required to commence work, with remaining balances due upon milestones or
                completion. Late payments may incur interest charges.
              </p>

              <h3 className="text-black font-bold mt-8 mb-4 text-xl">4. Limitation of Liability</h3>
              <p>
                In no event shall CoolCliQ, nor any of its officers, directors and employees, be
                held liable for anything arising out of or in any way connected with your use of
                this website or our services whether such liability is under contract.
              </p>
            </div>
          </section>
        </div>
        ...
        <div className="mt-20 p-6 bg-zinc-50 rounded-2xl border border-zinc-200 text-center">
          ...
          <p className="text-zinc-500 mb-4">
            If you have any questions about our legal policies, please contact us directly.
          </p>
          <a href="mailto:grow@coolcliq.in" className="text-brand-yellow font-bold hover:underline">
            grow@coolcliq.in
          </a>
        </div>
      </div>
